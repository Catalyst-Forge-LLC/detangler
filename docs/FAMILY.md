...
6. **Write the skills** (done in-repo). Site copy and install list both pairs. A public app sample is on `/docs/sample-app-report`: the aiBreze comb as written, then what was fixed and what was left.
